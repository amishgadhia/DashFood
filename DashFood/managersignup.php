<html>
  ...
  <head>
    <title> Manager Signup | DashFood' </title>
  </head>
  ...
  <body>
    ...
    <div class="container" style="height:10rem; !important">
    <div class="jumbotron">
     <h1 style="font-size:3rem">Hi Manager, <br> Welcome to <span class="edit"> DashFood </span></h1>
     <br>
   <p style="font-size:2rem">Get started by creating your account</p>
    </div>
    </div>



    <div class="container" style="margin-top: 14%; margin-bottom: 2%;">
      ...
      <div class="panel panel-primary">
        ...
        <div class="row">
          <div class="form-group col-xs-4">
              <button class="btn btn-primary" type="submit" style="transform: scale(1.2)!important; margin-left:8px; margin-top:10px">Sign up</button>
          </div>
